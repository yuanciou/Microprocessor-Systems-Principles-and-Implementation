...
# Adding an Floating-Point IP (multiply-add)
...
CONFIG.Maximum_Latency {false} ] [get_ips floating_point_0]
...
CONFIG.C_Latency {2}        \
CONFIG.Flow_Control {NonBlocking}  \
CONFIG.Maximum_Latency {false} ] [get_ips floating_point_add]
...
CONFIG.C_Latency {1}        \
CONFIG.Flow_Control {NonBlocking}  \
CONFIG.Maximum_Latency {false} ] [get_ips floating_point_mul]
